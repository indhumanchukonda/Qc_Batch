	...
	public static void history(String SSN,String AppURL) throws InterruptedException
	{
		...
		{	
			...
			if(SSN.equals(RegSSN))
			{
				...
				String loan_status = TestData.getCellData(sheetName_new_loan,"loan_status",row);
				...
				driver.switchTo().frame("mainFrame");
				driver.switchTo().frame("main");
				String loc_status= driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[2]/td/span[2]")).getText();
				test.log(LogStatus.PASS, "loc status is" +loc_status);
				if(loc_status.equalsIgnoreCase(loan_status))
					
				{
					test.log(LogStatus.PASS, "loan status->Expected value:"+loan_status +"; == Actual value:"+loc_status);
				}
				else
				{
					test.log(LogStatus.FAIL, "loan status->Expected value:"+loan_status.toLowerCase() +"; not equals to Actual value:"+loc_status.toLowerCase());
				}
...
*/				/*String loc_history_Stmt_Date_test= driver.findElement(locator(prop.getProperty("loc_history_Stmt_Date"))).getText();
				...
				/*if(ESign_CollateralType.equals("ACH"))
				{
					...
					ach_history_ach_effective_date= driver.findElement(locator(prop.getProperty("ach_history_ach_eff_date"))).getText();
		...
		//	ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+prop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls"); 
				...
				{		
					...
					String RegSSN = TestData.getCellData(sheetName,"SSN",row);	
						...
						String loan_status = TestData.getCellData(sheetName,"loan_status",row);
						...
						driver.switchTo().frame("mainFrame");
						driver.switchTo().frame("main");
						String loc_status= driver.findElement(By.xpath("//*[@id='revolvingCreditHistTable']/tbody/tr/td[3]/table/tbody/tr[3]/td/span[2]")).getText();
						test.log(LogStatus.PASS, "loc status is" +loc_status);//*[@id="transactionHistoryTable"]/tbody/tr/td[3]/table/tbody/tr[3]/td/span[2]
						if(loc_status.equalsIgnoreCase(loan_status))
