		...
		try{
		 ...
		 // Thread.sleep(4000);
		  ...
		  test.log(LogStatus.PASS, "Entered Password : "+password);
		   ...
		   test.log(LogStatus.PASS, " Selected"+SSNorITIN);
	   ...
	   System.out.println(Dob);
		test.log(LogStatus.PASS, "Entered DOB as  :"+ Dob);
		 ...
		 int i_security_question_a=Integer.parseInt(security_question_a);
		  ...
		  Thread.sleep(20000);
		  if(driver.findElement(By.xpath("//*[@id='msg']/center/span")).isDisplayed())
		  {
			  test.log(LogStatus.PASS, "test passed");
		  }
		  else
	...
	public static void payment(String SSN, String AppURL) throws Exception
	{
		try{
			...
			{	
				  ...
				  driver.findElement(By.xpath("//*[@id='othamountLoc']")).sendKeys("2");
				  driver.findElement(By.xpath("//*[@id='paymentType']")).sendKeys("Debit Card");
				  driver.findElement(By.xpath("//*[@id='fName']")).sendKeys(FirstName);
				  driver.findElement(By.xpath("//*[@id='lName']")).sendKeys(LastName);
				  driver.findElement(By.xpath("//*[@id='cardNumber']")).sendKeys(DebitCardNo);
				  driver.findElement(By.xpath("//*[@id='addres']")).sendKeys(ZipCode);
				  driver.findElement(By.xpath("//*[@id='zip']")).sendKeys(ZipCode);
				  //driver.findElement(By.xpath("//*[@id='rCardType']")).sendKeys(CardType);
				  driver.findElement(By.xpath("//*[@id='cvvNumber']")).sendKeys(CVV);
				  driver.findElement(By.xpath("//*[@id='rExpiresMonth']")).sendKeys(ExpiryMonth);
				  driver.findElement(By.xpath("//*[@id='rExpiresYear']")).sendKeys(ExpiryYear);
				  driver.findElement(By.xpath("//*[@id='continueBtn']")).click();

				  Thread.sleep(50000);
				   WebElement e = driver.findElement(By.xpath("//*[@id='back']/button"));
				  if(e.isDisplayed())
				  {
					  test.log(LogStatus.PASS, "Payment transaction is successfully completed");
				  }
				 driver.close();
