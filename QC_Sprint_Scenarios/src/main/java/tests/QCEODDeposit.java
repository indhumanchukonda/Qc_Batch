			...
			int lastrow=TestData.getLastRow("EOD_Deposit");
				...
				{		
					...
					test.log(LogStatus.PASS, "Clicked next under Over/short ");
						...
						driver.findElement(By.xpath("//*[@id='currentCheckBalanceTlp']/td/table/tbody/tr[3]/td[4]/select")).sendKeys("Manual");*/
						...
						//driver.findElement(By.xpath("//*[@id='currentCheckBalanceTlp']/td/table/tbody/tr[3]/td[4]/select")).sendKeys("Manual");
						driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr[2]/td[2]/table[2]/tbody/tr/td[2]/input[3]")).click();
