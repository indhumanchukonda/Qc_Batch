...
public class QCConversion extends QCStore {
		...
		{		
			...
			{		
				...
				for(int i=2;i<=n;i++){
					...
					test.log(LogStatus.PASS, "Collateral Type is enterted as "+ESign_CollateralType);
*/
					if(Pname.equals("MO Installment Loan"))
					{
		...
		{		
			...
			{		
				...
				for(int i=2;i<=n;i++){
					...
					if(Pname.equals("MO Signature Loan"))
					{
						driver.findElement(By.xpath("//*[@id='termSel1']")).click();
						test.log(LogStatus.PASS, "Selected check box as "+NewLoan_Term);
						/*if(NewLoan_Term.equals("Term1"))
	...
	public static void LOCConversion(String SSN,String AppURL) throws Exception{
		...
		{		
			...
			{		
				...
				String cardType = TestData.getCellData(sheetName_new_loan, "Card Type ", row);
				String cardNumber = TestData.getCellData(sheetName_new_loan, "Debit Card No", row);
				String cardEx_month = TestData.getCellData(sheetName_new_loan, "Expiry Month", row);
				String cardEx_Year = TestData.getCellData(sheetName_new_loan, "Expiry Year", row);
				String cvv = TestData.getCellData(sheetName_new_loan, "CVV", row);
				String CardHolderName = TestData.getCellData(sheetName_new_loan, "CardHolderName", row);
				String ESign_CourtesyCallConsent = TestData.getCellData(sheetName,"ESign_CourtesyCallConsent",row);
				String ESign_Preference = TestData.getCellData(sheetName,"ESign_Preference",row);
				...
				for(int i=2;i<=n;i++){
					...
					{
					driver.findElement(By.xpath("//*[@id='cardsListPay']/select")).sendKeys("NEW CARD");
					test.log(LogStatus.PASS, "Select card as : " + "NEW CARD");
					
					driver.findElement(By.xpath("//*[@id='cardTypepay']/select")).sendKeys(cardType);
					test.log(LogStatus.PASS, "Enterd card Type  : " + cardType);
					
					driver.findElement(By.xpath("//*[@id='ccnumberpay']")).sendKeys(cardNumber);
					test.log(LogStatus.PASS, "Card number is :" + cardNumber);

					driver.findElement(By.xpath("//*[@id='expmonthpay']")).sendKeys(cardEx_month);
					test.log(LogStatus.PASS, "Enterd Expiry month as" + cardEx_month);

					Select s = new Select(driver.findElement(By.xpath("//*[@id='expyearpay']")));
					//driver.findElement(By.xpath("//*[@id='expyearpay']")).sendKeys(cardEx_Year);
					s.selectByVisibleText("2025");
					test.log(LogStatus.PASS, "Entered Expiry year as" + cardEx_Year);

					//Thread.sleep(5000);
					//driver.findElement(By.xpath("(//*[@class='NewCardPay'])[4]/td[2]/input")).sendKeys(cvv);
					driver.findElement(By.xpath("//*[@name='cvvnumberpay']")).sendKeys(cvv);
					test.log(LogStatus.PASS, "Enterd CVV as " + cvv);
					
					driver.findElement(By.xpath("//*[@id='ccnamepay']")).sendKeys(CardHolderName);
					test.log(LogStatus.PASS, "Card holder name is " + CardHolderName);

					}
					else if(TenderType.equals("Check"))
					{
						driver.findElement(By.xpath("//*[@id='checkNbrFirst']/td[2]/input")).sendKeys(cvv);
						test.log(LogStatus.PASS, "check number entered as " + cvv);
					}
					...
					test.log(LogStatus.PASS, "ESign_Checks is selected as "+ESign_Password);
					Thread.sleep(3000);
					driver.findElement(By.xpath("//*[@name='finishadvance']")).click();
					test.log(LogStatus.PASS, "click on Finish Conversion button ");
					Thread.sleep(500);
					//------------------------------------------------------------------------------------------------------------		
					try {
					...
					driver.switchTo().frame("mainFrame");
					driver.switchTo().frame("main");
					//html/body/form/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td/input
					...
					{
						test.log(LogStatus.FAIL, "Conversion is not completed successfully ");
					}
					break;
