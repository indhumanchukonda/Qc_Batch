...
public static void LOC() throws InterruptedException
{
	...
	{					
		...
		if(State.equals("KS")){
			try{	
				//driver.findElement(By.xpath("//*[@name='requestBean.collateralType']")).sendKeys(ESign_CollateralType);
				Thread.sleep(20000);         //*[@id="riskViewBdy"]/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[2]/input
	...
	//String LOCamount = driver.findElement(By.xpath("//*[@id='errorMessage']/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td[2]/input")).getAttribute("value");
	  ...
	  String LOCamount=driver.findElement(By.name("advanceRequestBean.loanAmount")).getAttribute("value");
...
/*	String interesrrate=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[5]/table/tbody/tr[2]/td[2]")).getText();
	...
	//	Duedate_confirm_text3=Due_Date1+"/"+Due_Date2+"/"+Due_Date3;
		...
		test.log(LogStatus.PASS, "Disb amount is enterted as "+LOCamount);
		...
		if(ESign_CourtesyCallConsent.equalsIgnoreCase("Yes"))
		{
		 ...
		 /*String ChkgAcctNbr = SSN.substring(SSN.length() - 4);
		 driver.findElement(By.xpath("//*[@id='chkgAcctNbr']")).sendKeys(ChkgAcctNbr);
		//driver.findElement(By.name("advanceRequestBean.chkgAcctNbr")).sendKeys(ChkgAcctNbr);
		test.log(LogStatus.PASS, "check number entered as" +ChkgAcctNbr);*/
		//*[@id="chkgAcctNbr"]
		//'''''''''''''''''''''''''''''''''''''''''''''''//'''''''''''''''''''''''''''''''''''''''''''''//
