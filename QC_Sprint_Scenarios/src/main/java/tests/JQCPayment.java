...
*/			int lastrow=TestData.getLastRow("Payment");
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					driver.findElement(By.xpath("//*[@name='requestBean.transactionDataBean.ccmoNbrFirst']")).sendKeys("100");
					Thread.sleep(1000);	
...
/*break;
	...
	public static void checkreturnposting(String SSN,String AppURL) throws Exception
	{
		try{
