...
public class QCAdminLoginLogout extends CSR {
	...
	public static void adminlogin() throws InterruptedException
	{
		...
		//int lastrow=TestData.getLastRow("Smoke");
				...
				//test.log(LogStatus.PASS, "Application Launched with URL :"+"https://qclocalreg.qfund.net/cc/adminIndex.do");
				
				//driver.get("https://qclocalauto.qfund.net/cc/adminIndex.do");
				//test.log(LogStatus.PASS, "Application Launched with URL :"+"https://qclocalauto.qfund.net/cc/adminIndex.do");
				
				driver.get("https://192.168.2.230/cc/adminIndex.do");
				test.log(LogStatus.PASS, "Application Launched with URL :"+"https://192.168.2.230/cc/adminIndex.do");
