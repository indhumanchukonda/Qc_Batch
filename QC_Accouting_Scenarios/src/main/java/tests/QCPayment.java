	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					//-----22-11-2019 NSF Return check box issue-----//
					/*try {
					driver.findElement(By.xpath("//*[@id='payRtn1']/input[1]")).click();
					test.log(LogStatus.PASS, "Clicked on pay Return Fee amount check box ");
					}
					...
					Thread.sleep(500);
						...
						test.log(LogStatus.PASS, "Clicked on pay other amount check box ");
						String TenderAmt=driver.findElement(By.name("payOff")).getAttribute("value");
						
						driver.findElement(By.name("requestBean.siilBean.tenderTypeFirst")).sendKeys(TenderType);
						test.log(LogStatus.PASS, "Tender Type is :"+TenderType);
						driver.findElement(By.name("requestBean.siilBean.tenderAmtFirst")).sendKeys(TenderAmt.trim());
						test.log(LogStatus.PASS, "TenderAmount is :"+TenderAmt);	
					}
						...
						Tender_Amt=driver.findElement(By.name("instAmt")).getAttribute("value");
						test.log(LogStatus.PASS, "Getting TenderAmount is :"+Tender_Amt);
						
						driver.findElement(By.name("requestBean.siilBean.tenderTypeFirst")).sendKeys(TenderType);
						test.log(LogStatus.PASS, "Tender Type is :"+TenderType);
						driver.findElement(By.name("requestBean.siilBean.tenderAmtFirst")).sendKeys(Tender_Amt.trim());
						test.log(LogStatus.PASS, "TenderAmount is :"+Tender_Amt);
						
						Payment_Inst= driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr[11]/td/table/tbody/tr[2]/td[2]/input")).getAttribute("value");
						test.log(LogStatus.PASS, "Getting Payment_Instrest is :"+Payment_Inst);
						
						Payment_cso= driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr[11]/td/table/tbody/tr[2]/td[10]/input")).getAttribute("value");
						test.log(LogStatus.PASS, "Getting Payment_cso is :"+Payment_cso);
					}
	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					driver.findElement(By.name("requestBean.siilBean.payAmt")).sendKeys(TenderAmount);
					test.log(LogStatus.PASS, "PaymentAmount entered :"+PaymentAmount);
					driver.findElement(By.name("requestBean.siilBean.tenderTypeFirst")).sendKeys(TenderType);
					test.log(LogStatus.PASS, "Tender Type is :"+TenderType);
					driver.findElement(By.name("requestBean.siilBean.tenderAmtFirst")).sendKeys(TenderAmount);
