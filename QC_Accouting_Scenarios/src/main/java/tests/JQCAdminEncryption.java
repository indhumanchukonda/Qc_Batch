...
break;
	...
	public static void getManualEncryption(WebDriver driver,String SSN,String AppURL) throws InterruptedException
	{
	...
	test.log(LogStatus.PASS, "Trancd selected as: "+Trancd);
