		...
		{		
			...
			{		
				...
				if(stepupmsg.contains("Same")){
					...
					String payment_Amount = driver.findElement(By.xpath("//*[@id='showPaymentAmt']/td[2]/input")).getAttribute("value");
					
					driver.findElement(By.xpath("//*[@id='showTenderAmt']/td[2]/input")).clear();
					driver.findElement(By.xpath("//*[@id='showTenderAmt']/td[2]/input")).sendKeys(payment_Amount);
...
*/
	...
	public static void StepUp_CashOut_Yes(String SSN,String AppURL) throws Exception{
	String sheetName="ReFinance";	
	int lastrow=TestData.getLastRow(sheetName);
	...
	{		
		...
		{		
			...
			if(stepupmsg.contains("Step")){
				...
				driver.switchTo().frame("main");
				String payment_amount = driver.findElement(By.xpath("//*[@id='showPaymentAmt']/td[2]/input")).getAttribute("value");
				test.log(LogStatus.PASS, "payment amount is:" +payment_amount);
