						   ...
						   driver.switchTo().defaultContent();
							...
							if(ESign_CollateralType.equalsIgnoreCase("DEBIT CARD"))
							{
								...
								// driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[4]/td[13]/input")).click();
								 ...
								 wait.until(ExpectedConditions.visibilityOfElementLocated(By.name("transactionList")));
								 driver.findElement(By.name("transactionList")).sendKeys("Debit Card Deposit");
								/* WebElement transaction_type = driver .findElement(By.xpath("//*[@name='transactionList']"));
								 Select s = new Select(transaction_type);
								 s.selectByValue("DCDP");*/
								 test.log(LogStatus.PASS, "Transaction type is selected"+ESign_CollateralType+" Deposit");
								 driver.findElement(By.id("go_Button")).click();
								 test.log(LogStatus.PASS, "Click on GO Button after transaction type selection ");
								 Thread.sleep(2000);
