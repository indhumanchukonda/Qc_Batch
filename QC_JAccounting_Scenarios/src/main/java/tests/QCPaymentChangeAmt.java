	...
	try{
			...
			{		
				...
				if(SSN.equals(RegSSN))
				{
					...
					String checkNbrFirst = TestData.getCellData(sheetName,"checkNbrFirst",row);
					...
					/*	
					 if(Scenario.equalsIgnoreCase("Partial_Return_Payment"))
						{*/
						 ...
						 /*driver.findElement(By.name("transactionDataBean.checkNbrFirst")).sendKeys(checkNbrFirst);
						 test.log(LogStatus.PASS, "Tender Type is :"+checkNbrFirst);*/
