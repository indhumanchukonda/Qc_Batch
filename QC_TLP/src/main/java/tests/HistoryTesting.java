...
public class HistoryTesting extends QCStore{
	...
	public static String Loan_ABA_Nbr;
	public static String Promotion_Amt;
	...
	public static void testing(String SSN, String AppURL) throws InterruptedException, ParseException
	{
...
//ACH collateral details from sheet
			...
			//	test.log(LogStatus.INFO, MarkupHelper.createLabel("Transaction History validation has started", ExtentColor.BLUE));
				...
				for(String winHandle : driver.getWindowHandles()){
				    ...
				    Thread.sleep(5000);        ////*[@id="CustGrid"]/tbody/tr[2]/td[13]/table/tbody/tr/td[1]/select 
				    driver.findElement(By.xpath("//*[@id='CustGrid']/tbody/tr[2]/td[13]/table/tbody/tr/td[1]/select")).sendKeys("History");
				                   //*[@id="CustGrid"]/tbody/tr[2]/td[13]/table/tbody/tr/td[1]/select
				    driver.findElement(By.xpath("//*[@id='go_Button']")).click();
				    
				    //Customer Information
				  //*[@id="transactionHistoryTable"]/tbody/tr/td[1]/table/tbody/tr[2]/td/span[2]/span/span[1]
				    ...
				    String customer_Nbr = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[3]/td/span[2]/span")).getText();
					 test.log(LogStatus.PASS, "customer_Nbr" + customer_Nbr);
					   ...
					   test.log(LogStatus.PASS, "Email:  " + Email);
					    ...
					    //Bank Information
					    test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold>Bank Information</b>");
					    ...
					    test.log(LogStatus.PASS, "Type of account is :" +type_of_account);
					 ...
					 test.log(LogStatus.PASS, "Account_status:  " + Account_status);
					   ...
					   test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> UnderWriting Information </b>");
					  ...
					  //Promotion/Coupon Info
					    test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Promotion/Coupon Info </b>");
					                                                         //*[@id="transactionHistoryTable"]/tbody/tr/td[1]/table/tbody/tr[24]/td/span[2]
					    String Campaign_Name = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[24]/td/span[2]")).getText();
					    test.log(LogStatus.PASS, "Campaign_Name:" +Campaign_Name);
					    
					    String promotioncode = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[25]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "promotion_code:  " + promotioncode);
					    
					   //Co_Owner Information
					   test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Co_Owner Information </b>");
					   String Name = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[28]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "Name:  " + Name);
					   
					   String ITIN = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[29]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "ITIN:  " + ITIN);
					   
					   String Address = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[30]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "Address:  " + Address);
					   
					   String Phone_Nbr = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[1]/table/tbody/tr[31]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "Phone_Nbr:  " + Phone_Nbr);
					   
					 //Employer Information
					   test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Employer Information </b>");
					 ...
					 //Courtesy/Collection Information
					   test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Courtesy/Collection Information </b>");
					...
					test.log(LogStatus.PASS,"Granishment_Date: " +Granishment_Date);
					 ...
					 //Loan Account Status
					   test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Loan Account Status </b>");
					 ...
					 //Loan Balance Summery
					    test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Loan Balance Summery </b>");
					...
					test.log(LogStatus.PASS, "Principle_Balance: " + Principle_Balance);
					   ...
					   String Repo_Fee_Due = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[20]/td/span[2]")).getText();
					   ...
					   test.log(LogStatus.PASS, "Verification_Fee_due: " + Verification_Fee_due);
					    ...
					    String Pay_off_Amt = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[22]/td/span[2]")).getText();
					  test.log(LogStatus.PASS, "Pay_off_Amt: " + Pay_off_Amt);
					    
					    String Past_Due_Amt = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[23]/td/span[2]")).getText();
					  test.log(LogStatus.PASS, "Past_Due_Amt: " + Past_Due_Amt);
					   ...
					   test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Loan Paid To_Date Summery </b>");
					    String Principal_Paid_to_date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[26]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "Principal_Paid_to_date: " + Principal_Paid_to_date);
					    
					    String Intrest_Paid_to_date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[27]/td/span[2]")).getText();
					  ...
					  String Repo_Fee_Paid_to_date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[30]/td/span[2]")).getText();
					  test.log(LogStatus.PASS, "Repo_Fee_Paid_to_date: " + Repo_Fee_Paid_to_date);
					    
					    String Total_Paid_Amt = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[31]/td/span[2]")).getText();
					   ...
					   String Orig_Fee_Paid = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[33]/td/span[2]")).getText();
					   test.log(LogStatus.PASS, "Orig_Fee_Paid: " + Orig_Fee_Paid);
					 
					    String Orig_Fee_Waived = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[3]/table/tbody/tr[34]/td/span[2]")).getText();
					    test.log(LogStatus.PASS, "Orig_Fee_Waived:  " + Orig_Fee_Waived);
					    
					   
					//Loan Account Information
					 test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Loan Account Information </b>");
					  Thread.sleep(2000);
					  ///html/body/form/table/tbody/tr[1]/td/table/tbody/tr/td/table/tbody/tr[3]/td[4]/table/tbody/tr/td[4]/table/tbody/tr[2]/td/text()
					                                                    //*[@id="transactionHistoryTable"]/tbody/tr/td[4]/table/tbody/tr[2]/td/text()
				   ////*[@id="transactionHistoryTable"]/tbody/tr/td[4]/table/tbody/tr[2]/td/text()
				  ...
				  String DMV_Fee = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[6]/td/span[2]")).getText();
				  test.log(LogStatus.PASS, "DMV_Fee: " + DMV_Fee);
				  
				  String Waive_DMV_Fee = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[7]/td/span[2]")).getText();
				  ...
				  test.log(LogStatus.PASS, "APR: " + APR);
				    ...
				    String Intrest_Fee = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[9]/td/span[2]")).getText();
				  test.log(LogStatus.PASS, "Intrest_Fee: " + Intrest_Fee);
				    
				    String Loan_Date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[10]/td/span[2]")).getText();
				 test.log(LogStatus.PASS, "Loan_Date:  " + Loan_Date);
				    
				    String Installment_Amt = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[11]/td/span[2]")).getText();
				  test.log(LogStatus.PASS, "Installment_Amt: " + Installment_Amt);
				    
				    String Number_of_installments = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[12]/td/span[2]")).getText();
				  test.log(LogStatus.PASS, "Number_of_installments: " + Number_of_installments);
				    
				    String Collateral_Type = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[13]/td/span[2]")).getText();
				   test.log(LogStatus.PASS, "Collateral_Type: " + Collateral_Type);
				    
				    String Loan_Frequency = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[14]/td/span[2]")).getText();
				  test.log(LogStatus.PASS, "Loan_Frequency:  " + Loan_Frequency);
				    
				    String Origination_Store = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[15]/td/span[2]")).getText();
				  test.log(LogStatus.PASS, "Origination_Store:  " + Origination_Store);
				//*[@id="transactionHistoryTable"]/tbody/tr/td[4]/table/tbody/tr[16]/td/text()
				    String Verification_Fee = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[16]/td")).getText();
				    ...
				    String Available_Credit = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[17]/td/span[2]")).getText();
				   test.log(LogStatus.PASS, "Available_Credit:  " + Available_Credit);
				   
				   String Payroll_Deduction_Signed = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[18]/td/span[2]")).getText();
				   test.log(LogStatus.PASS, "Payroll_Deduction_Signed:  " + Payroll_Deduction_Signed);
				    
				   try
				   {
				  //Loan Bank Account Information
					 test.log(LogStatus.INFO,"<b> <FONT color=blue style=Bold> <FONT color=blue style=Bold> Loan Bank Account Information </b>");
				    Loan_ABA_Nbr = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[19]/td/span[2]")).getText();
				 ...
				 //*[@id="transactionHistoryTable"]/tbody/tr/td[4]/table/tbody/tr[22]/td/span[2]
				   String Transfer_Out_Date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[22]/td/span[2]")).getText();
				   test.log(LogStatus.PASS,"Transfer_Out_Date: " +Transfer_Out_Date);
				   
				   String Transfer_In_Date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[23]/td/span[2]")).getText();
				   test.log(LogStatus.PASS,"Transfer_In_Date: " +Transfer_In_Date);
				   
				    String Account_Sold = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[24]/td/span[2]")).getText();
				  test.log(LogStatus.INFO, "Account_Sold:  " + Account_Sold);
				  
				  String Sold_To = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[25]/td/span[2]")).getText();
				  test.log(LogStatus.PASS,"Sold_To: " +Sold_To);
				  
				  String Sold_date = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[26]/td/span[2]")).getText();
				  test.log(LogStatus.PASS,"Sold_date: " +Sold_date);
				    
				    String Mark_For_Sale = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[27]/td/span[2]")).getText();
				   test.log(LogStatus.PASS, "Mark_For_Sale:  " + Mark_For_Sale);
				   
				   String Agency_Name = driver.findElement(By.xpath("//*[@id='transactionHistoryTable']/tbody/tr/td[4]/table/tbody/tr[28]/td/span[2]")).getText();
				  ...
				  String Loc_Nbr = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[2]")).getText();
				  test.log(LogStatus.PASS, "Loc_Nbr:" + Loc_Nbr);
				  
				  String Other_Loc_Nbr = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[3]")).getText();
				  test.log(LogStatus.PASS, "Other_Loc_Nbr:" + Other_Loc_Nbr);
				  
				  Trans_Date = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[4]")).getText();
				  test.log(LogStatus.PASS, "Trans_Date:" + Trans_Date);
				  
				  Transaction = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[5]")).getText();
				  test.log(LogStatus.PASS, "Transaction:" + Transaction);
				  
				  Total_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[6]")).getText();
				  test.log(LogStatus.PASS, "Total_Amt:" + Total_Amt);
				  
				  Tender_Type = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[7]")).getText();
				  test.log(LogStatus.PASS, "Tender_Type:" + Tender_Type);
				  
				  String Vehicle_Status = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[8]")).getText();
				  test.log(LogStatus.PASS, "Vehicle_Status:" + Vehicle_Status);
				  ...
				  test.log(LogStatus.PASS, "Interest_list:" + Interest);
				  
				  String Cso_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[12]")).getText();
				  test.log(LogStatus.PASS, "Cso_Fee:" + Cso_Fee);
				  
				  String Nsf_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[13]")).getText();
				  test.log(LogStatus.PASS, "Nsf_Fee_list:" + Nsf_Fee);
				  ...
				  String Repo_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[15]")).getText();
				  test.log(LogStatus.PASS, "Repo_Fee:" + Repo_Fee);
				  
				  String Sale_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[16]")).getText();
				  test.log(LogStatus.PASS, "Sale_Fee:" + Sale_Fee);
				  
				  String Refund_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[17]")).getText();
				  test.log(LogStatus.PASS, "Refund_Amt:" + Refund_Amt);
				  
				  String Emp_Nbr = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[18]")).getText();
				  test.log(LogStatus.PASS, "Emp_Nbr:" + Emp_Nbr);
				  
				  String Other_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[19]")).getText();
				  test.log(LogStatus.PASS, "Other_Fee:" + Other_Fee);
				  
				  String Orgi_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[20]")).getText();
				  test.log(LogStatus.PASS, "Orgi_Fee:" + Orgi_Fee);
				  
				  String Verification_fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[21]")).getText();
				  test.log(LogStatus.PASS, "Verification_fee:" + Verification_fee);
				  
				  Promotion_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[22]")).getText();
				  test.log(LogStatus.PASS, "Promotion_Amt:" + Promotion_Amt);
				  
				  String Owner = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[23]")).getText();
				  test.log(LogStatus.PASS, "Owner:" + Owner);
				  
				  String Coupon_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[24]")).getText();
				  test.log(LogStatus.PASS, "Coupon_Amt:" + Coupon_Amt);
				  
				  /*String Online_Transaction = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[25]")).getText();
				  test.log(LogStatus.INFO, "Online_Transaction:" + Online_Transaction);
				                                                */
				  //*[@id="transactionDetailsTable"]/tbody/tr[1]/td[25]
				    try{                                                            //*[@id="transactionDetailsTable"]/tbody/tr[1]/td[25]
				  String Online_Transaction_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[25]")).getText();
				  test.log(LogStatus.INFO, "Online_Transaction_list:" + Online_Transaction_list);
				    }
				    catch(Exception e)
				    {
				    	e.getMessage();
				    ...
				    for(int i=list.size()-1;i<list.size();i++){
				    	//test.log(LogStatus.INFO, "Last Row");
				    String Loc_Nbr = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[2]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Loc_Nbr:" + Loc_Nbr);
				  
				  String Other_Loc_Nbr = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[3]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Other_Loc_Nbr:" + Other_Loc_Nbr);
				  
				  Trans_Date = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[4]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Trans_Date:" + Trans_Date);
				  
				  Transaction = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[5]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Transaction:" + Transaction);
				  
				  Total_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[6]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Total_Amt:" + Total_Amt);
				  
				  Tender_Type = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[7]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Tender_Type:" + Tender_Type);
				  
				  String Vehicle_Status = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[8]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Vehicle_Status:" + Vehicle_Status);
				  
				  String Inst_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[9]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Inst_list:" + Inst_list);
				  
				  Adv_amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[10]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Adv_amt_list:" + Adv_amt);
				  
				  Interest = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[11]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Interest_list:" + Interest);
				  
				  String CSO_Fee_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[12]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> CSO_Fee_list:" + CSO_Fee_list);
				  
				  String Nsf_Fee_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[13]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Nsf_Fee_list:" + Nsf_Fee_list);
				  
				  String Late_fee_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[14]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Late_fee_list:" + Late_fee_list);
				  
				  String Repo_fee_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[15]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Repo_fee_list:" + Repo_fee_list);
				  
				  String Sale_fee_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[16]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Sale_fee_list:" + Sale_fee_list);
				  
				  String Refund_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[17]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Refund_Amt:" + Refund_Amt);
				  
				  String Emp_Nbr = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[18]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Emp_Nbr:" + Emp_Nbr);
				  
				  String Other_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[19]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Other_Fee:" + Other_Fee);
				  
				  String Orgi_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[20]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Orgi_Fee:" + Orgi_Fee);
				  
				  String TVerification_Fee = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[21]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> TVerification_Fee:" + TVerification_Fee);
				  
				  Promotion_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[22]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Promotion_Amt:" + Promotion_Amt);
				  
				  String Owner = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[23]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Owner:" + Owner);
				  
				  String Coupon_Amt = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[24]")).getText();
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial> Coupon_Amt:" + Coupon_Amt);
				  
			/*	  String Online_Transaction = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[25]")).getText();
				  test.log(LogStatus.INFO, "<FONT color=green style=Arial> Online_Transaction:" + Online_Transaction);*/
				  ...
				  test.log(LogStatus.PASS, "<FONT color=green style=Arial>" +Transaction +"Transaction Completed" );
					...
					else
					{
						...
						if(loan_account_inf_no_of_installments_test.equalsIgnoreCase(Number_of_installments))
						{
							test.log(LogStatus.PASS, "No of Instalments->Expected value:"+loan_account_inf_no_of_installments_test +"; == Actual value:"+Number_of_installments);
						}
						else
						{
							test.log(LogStatus.FAIL, "No of Instalments->Expected value:"+loan_account_inf_no_of_installments_test +"; not equals to Actual value:"+Number_of_installments);

						}
						
						if(collateral_type.equalsIgnoreCase(Collateral_Type)||"DC".equalsIgnoreCase(Collateral_Type))
						{
				...
				*/		if(courtesy_inf_courtesy_status_test.equalsIgnoreCase(Status))
						{
							test.log(LogStatus.PASS, "courtesy_consent_status->Expected value:"+courtesy_inf_courtesy_status_test +"; == Actual value:"+Status);
						}
						else
						{
							test.log(LogStatus.FAIL, "courtesy_consent_status->Expected value:"+courtesy_inf_courtesy_status_test +"; not equals to Actual value:"+Status);
						...
						if(fee_due.equalsIgnoreCase(Earned_and_unpaid_intrest))
						{
							test.log(LogStatus.PASS, "Earned and unpaid interest->Expected value:"+fee_due +"; == Actual value:"+Earned_and_unpaid_intrest);
						}
						else
						{
							test.log(LogStatus.FAIL, "Earned and unpaid interest:"+fee_due +"; not equals to Actual value:"+Earned_and_unpaid_intrest);
						...
						{
							test.log(LogStatus.PASS, "Interest paid to date->Expected value:"+fee_paid_date +"; == Actual value:"+Intrest_Paid_to_date);
						}
						else
						{
							test.log(LogStatus.FAIL, "Interest paid to date-->Expected value:"+fee_paid_date +"; not equals to Actual value:"+Intrest_Paid_to_date);

						}
						
						if(loan_paid_summary_total_paid_amt_test.equalsIgnoreCase(Total_Paid_Amt))
						{
							test.log(LogStatus.PASS, "total_paid_amount->Expected value:"+loan_paid_summary_total_paid_amt_test +"; == Actual value:"+Total_Paid_Amt);
						}
						else
						{
							test.log(LogStatus.FAIL, "total_paid_amount->Expected value:"+loan_paid_summary_total_paid_amt_test +"; not equals to Actual value:"+Total_Paid_Amt);
				...
				*/		if(product_name.equalsIgnoreCase(product_name))
						...
						if(tran_date_sheet.isEmpty()){
							if(appdate.equalsIgnoreCase(Trans_Date))
							{
								test.log(LogStatus.PASS, "transaction date->Expected value:"+appdate +"; == Actual value:"+Trans_Date);
							}
							else
							{
								test.log(LogStatus.FAIL, "transaction date->Expected value:"+appdate +"; not equals to Actual value:"+Trans_Date);

							}	
						}
						else{
						if(tran_date_sheet.equalsIgnoreCase(Trans_Date))
						{
							test.log(LogStatus.PASS, "transaction date->Expected value:"+appdate +"; == Actual value:"+Trans_Date);
						}
						else
						...
						if(cust_tran_test.equalsIgnoreCase(Transaction))
						{
							test.log(LogStatus.PASS, "Transaction->Expected value:"+cust_tran_test +"; == Actual value:"+Transaction);
						}
						else
						{
							test.log(LogStatus.FAIL, "Transaction->Expected value:"+cust_tran_test +"; not equals to Actual value:"+Transaction);

						}
						if(cust_doc_total_amount_test.equalsIgnoreCase(Total_Amt))
						{
							test.log(LogStatus.PASS, "total_amount->Expected value:"+cust_doc_total_amount_test +"; == Actual value:"+Total_Amt);
						}
						else
						{
							test.log(LogStatus.FAIL, "total_amount->Expected value:"+cust_doc_total_amount_test +"; not equals to Actual value:"+Total_Amt);

						}
						if(cust_doc_tender_type_test.equalsIgnoreCase(Tender_Type)||" ".trim().equalsIgnoreCase(Tender_Type.trim()))
						{
							test.log(LogStatus.PASS, "Tender type->Expected value:"+cust_doc_tender_type_test +"; == Actual value:"+Tender_Type);
						}
						else
						{
							test.log(LogStatus.FAIL, "Tender type->Expected value:"+cust_doc_tender_type_test +"; not equals to Actual value:"+Tender_Type);

						}
						if(cust_doc_inst_test.equalsIgnoreCase(Inst))
						{
							test.log(LogStatus.PASS, "Inst#->Expected value:"+cust_doc_inst_test +"; == Actual value:"+Inst);
						}
						else
						{
							test.log(LogStatus.FAIL, "Inst#->Expected value:"+cust_doc_inst_test +"; not equals to Actual value:"+Inst);

						}
						if(cust_doc_adv_amount_test.equalsIgnoreCase(Adv_amt))
						{
							test.log(LogStatus.PASS, "Adv amount->Expected value:"+cust_doc_adv_amount_test +"; == Actual value:"+Adv_amt);
						}
						else
						{
							test.log(LogStatus.FAIL, "Adv amount->Expected value:"+cust_doc_adv_amount_test +"; not equals to Actual value:"+Adv_amt);

						}	
						if(cust_doc_interest_test.equalsIgnoreCase(Interest))
						{
							test.log(LogStatus.PASS, "Interest->Expected value:"+cust_doc_interest_test +"; == Actual value:"+Interest);
						}
						else
						{
							test.log(LogStatus.FAIL, "Interest->Expected value:"+cust_doc_interest_test +"; not equals to Actual value:"+Interest);
						...
						if(cust_doc_PromotionCoupon_Amt_test.equalsIgnoreCase(Promotion_Amt)||" ".trim().equalsIgnoreCase(Promotion_Amt.trim()))
						{
							test.log(LogStatus.PASS, "Promotion/Coupon Amt->Expected value:"+cust_doc_PromotionCoupon_Amt_test +"; == Actual value:"+Promotion_Amt);
						}
						else
						{
							test.log(LogStatus.FAIL, "Promotion/Coupon Amt->Expected value:"+cust_doc_PromotionCoupon_Amt_test +"; not equals to Actual value:"+Promotion_Amt);
