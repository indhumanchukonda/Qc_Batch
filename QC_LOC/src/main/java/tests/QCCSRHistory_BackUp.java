...
//Loan paid to date summary
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(prop.getProperty("loc_history_transaction"))).getText();
						...
						if(prop.getProperty("CSR_URL").equalsIgnoreCase("https://qclocalauto.qfund.net/cc/demoIndex.do")){
						loan_paid_summary_total_paid_amt= driver.findElement(locator(prop.getProperty("loan_paid_summary_total_paid_amt"))).getText();
						loan_paid_summary_repo_fee_paid=driver.findElement(locator(prop.getProperty("loan_paid_summary_repo_fee_paid"))).getText();
						}else{
						...
						if(prop.getProperty("CSR_URL").equalsIgnoreCase("https://qclocalauto.qfund.net/cc/demoIndex.do")){
							...
							loan_balance_inf_Current_Principal_Balance=driver.findElement(locator(prop.getProperty("loan_balance_inf_Current_Principal_Balance"))).getText();
