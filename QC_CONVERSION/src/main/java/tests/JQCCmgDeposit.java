		       ...
		       Thread.sleep(1000);
				...
				for(int i=4;i<=n;i++){
					...
					if(check_Nbr.contains(CheckNbr)){
						                                    ////*[@id="pdlHeldCollateralChecks"]
					WebElement e4=driver.findElement(By.xpath("//*[@id='pdlHeldCollateralChecks']"));			
					e4.click();
					test.log(LogStatus.PASS, "Clicked on check box ");
					//driver.findElement(By.xpath("/html/body/form/table/tbody/tr/td/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr[7]/td[5]/select")).sendKeys("Manual");
				...
				Thread.sleep(5000);
				driver.findElement(By.xpath("//*[@name='finishdeposit']")).click();
