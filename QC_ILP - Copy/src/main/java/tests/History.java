...
public class History extends QCStore{
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("/html/body/form/div[2]/div/div[1]/div[2]/div[2]/table/tbody/tr[1]/td[2]/input")).sendKeys("csr3244");
		driver.findElement(By.xpath("/html/body/form/div[2]/div/div[1]/div[2]/div[2]/table/tbody/tr[2]/td[2]/input")).sendKeys("1234");
		driver.findElement(By.xpath("/html/body/form/div[2]/div/div[1]/div[2]/div[2]/table/tbody/tr[3]/td[2]/input")).sendKeys("3244");
		...
		driver.findElement(By.name("ssn3")).sendKeys("1335");
		...
		for(String winHandle : driver.getWindowHandles()){
		    ...
		    test.log(LogStatus.PASS, "Customer Information");
		   ...
		   // System.out.println("customer_Nbr:" +customer_Nbr);
		    ...
		    test.log(LogStatus.PASS, "Customer Active Bank Information");
		    ...
		    test.log(LogStatus.PASS, "UnderWriting Information");
		    ...
		    test.log(LogStatus.PASS,"Promotion/Coupon Info");
		    ...
		    */
		    ...
		    test.log(LogStatus.PASS,"Employer Information");
		    ...
		    test.log(LogStatus.PASS, "Courtesy/Collection Information");
		   ...
		   int j=loan_tran_code.size();
		    ...
		    {
		    	String loan_tran_code_list = driver.findElement(By.xpath("//*[@id='transactionDetailsTable']/tbody/tr["+i+"]/td[2]")).getText();
		    ...
		    List<WebElement> loc_Nbr = driver.findElements(By.xpath("//*[@id='transactionDetailsTable']//td[3]"));
             ...
             List<WebElement> Trans_date = driver.findElements(By.xpath("//*[@id='transactionDetailsTable']//td[5]"));
              ...
              List<WebElement> Total_Amt = driver.findElements(By.xpath("//*[@id='transactionDetailsTable']//td[7]"));
			    ...
			    {
			    	String value = driver.findElement(By.xpath("(//*[@name='collateralTypeId']/option)[1]")).getText();
